...
// CONCATENATED MODULE: ./src/components/Hue.vue?vue&type=template&id=160c5740&scoped=true&
...
// EXTERNAL MODULE: ./node_modules/jshue/src/jshue.js
var jshue = __webpack_require__("1248");
var jshue_default = /*#__PURE__*/__webpack_require__.n(jshue);

// EXTERNAL MODULE: ./node_modules/vue-circle-slider/index.js
var vue_circle_slider = __webpack_require__("deba");

// EXTERNAL MODULE: ./node_modules/lodash/lodash.js
var lodash = __webpack_require__("2ef0");
var lodash_default = /*#__PURE__*/__webpack_require__.n(lodash);

// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib??ref--12-1!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Hue.vue?vue&type=script&lang=js&
...
/* harmony default export */ var Huevue_type_script_lang_js_ = ({
  name: 'hue',
  components: {
    CircleSlider: vue_circle_slider["CircleSlider"]
  },
  props: {},
  data: function data() {
    return {
  ...
  watch: {
    brightness: lodash_default.a.debounce(function () {
      this.user.setLightState(this.index, {
        bri: this.brightness
      }).then(function (data) {});
    }, 1000)
  },
  mounted: function mounted() {
    ...
    var hue = jshue_default()();
    hue.discover().then(function (bridges) {
      if (bridges.length === 0) {
        _this.message.bridge = 'No bridge found. :(';
      } else {
        bridges.forEach(function (b) {
          return _this.ips.push(b.internalipaddress);
        });
      }

      _this.ips.forEach(function (ip) {
        return _this.message.bridge = 'Bridge has been found at IP : ' + ip + ', please press button';
      });

      var bridge = hue.bridge(_this.ips[0]);

      if (_this.cacheManager.get('username')) {
        _this.user = bridge.user(_this.cacheManager.get('username'));

        _this.user.getLights().then(function (data) {
          _this.lights = data; // for (let key in this.lights) {
        ...
        var interval = setInterval(function () {
          bridge.createUser('ureflect_app#testdevice').then(function (data) {
            if (data[0].error) {} else {
              var username = data[0].success.username;

              _this.cacheManager.store('username', username);
      ...
      return _this.message.bridge = 'Error finding bridges ' + e;
    });
  },
  methods: {
    switchLight: function switchLight(index, state) {
      var _this2 = this;

      this.user.setLightState(index, {
        on: state
      }).then(function (data) {
        _this2.lights[index].state.on = state;
      });
    },
    changeBrightness: function changeBrightness(index) {
      this.index = index;
      this.brightness = this.lights[index].state.bri;
    }
  }
});
// CONCATENATED MODULE: ./src/components/Hue.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_Huevue_type_script_lang_js_ = (Huevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/components/Hue.vue?vue&type=style&index=0&id=160c5740&scoped=true&lang=css&
var Huevue_type_style_index_0_id_160c5740_scoped_true_lang_css_ = __webpack_require__("b14c");
...
// CONCATENATED MODULE: ./src/components/Hue.vue
...
var component = normalizeComponent(
  components_Huevue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var Hue = (component.exports);
// CONCATENATED MODULE: /Users/albanbin/.config/yarn/global/node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (Hue);
...
"use strict";
/* harmony import */ var _config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Hue_vue_vue_type_style_index_0_id_160c5740_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("b7a7");
/* harmony import */ var _config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Hue_vue_vue_type_style_index_0_id_160c5740_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Hue_vue_vue_type_style_index_0_id_160c5740_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Hue_vue_vue_type_style_index_0_id_160c5740_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
"use strict";
/* harmony import */ var _dist_vue_circle_slider_common_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("0c2a");
/* harmony import */ var _dist_vue_circle_slider_common_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_dist_vue_circle_slider_common_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (checked) */ if(__webpack_require__.o(_dist_vue_circle_slider_common_js__WEBPACK_IMPORTED_MODULE_0__, "CircleSlider")) __webpack_require__.d(__webpack_exports__, "CircleSlider", function() { return _dist_vue_circle_slider_common_js__WEBPACK_IMPORTED_MODULE_0__["CircleSlider"]; });

/* harmony import */ var _dist_vue_circle_slider_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("ead6");
/* harmony import */ var _dist_vue_circle_slider_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_dist_vue_circle_slider_css__WEBPACK_IMPORTED_MODULE_1__);

/* unused harmony default export */ var _unused_webpack_default_export = (_dist_vue_circle_slider_common_js__WEBPACK_IMPORTED_MODULE_0___default.a);
...
/******/ })["default"];
//# sourceMappingURL=ur-hue.common.js.map