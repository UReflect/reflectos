(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ur-calendar"] = factory();
	else
		root["ur-calendar"] = factory();
...
;(function (global, factory) {
    true ? factory(__webpack_require__("c206")) :
   undefined
...
"use strict";
/* harmony import */ var _config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_2_id_d54287be_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("71c9");
/* harmony import */ var _config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_2_id_d54287be_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_2_id_d54287be_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_2_id_d54287be_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: /Users/albanbin/Documents/dev/ureflect/boilerplate/node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"0595ba96-vue-loader-template"}!/Users/albanbin/.config/yarn/global/node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!/Users/albanbin/Documents/dev/ureflect/boilerplate/node_modules/cache-loader/dist/cjs.js??ref--0-0!/Users/albanbin/Documents/dev/ureflect/boilerplate/node_modules/vue-loader/lib??vue-loader-options!./Calendar.vue?vue&type=template&id=d54287be&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"modal-mask",style:({display: _vm.showModal ? 'table' : 'none'})},[_c('div',{staticClass:"modal-wrapper"},[_c('div',{staticClass:"modal-container"},[_c('div',{staticClass:"modal-body"},[_vm._t("body",[_c('form',{attrs:{"method":"post"},on:{"submit":_vm.addEvent}},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.form.name),expression:"form.name"}],attrs:{"id":"name","type":"text","name":"name","placeholder":"Enter title","required":""},domProps:{"value":(_vm.form.name)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.form, "name", $event.target.value)}}}),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.form.place),expression:"form.place"}],attrs:{"id":"place","type":"text","name":"place","placeholder":"Enter place"},domProps:{"value":(_vm.form.place)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.form, "place", $event.target.value)}}}),_c('textarea',{directives:[{name:"model",rawName:"v-model",value:(_vm.form.desc),expression:"form.desc"}],attrs:{"id":"desc","type":"text","name":"desc","placeholder":"Enter description"},domProps:{"value":(_vm.form.desc)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.form, "desc", $event.target.value)}}}),_c('div',{staticStyle:{"display":"flex"}},[_c('div',{staticStyle:{"margin":"auto","display":"flex"}},[_c('div',{staticClass:"btn-submit",staticStyle:{"margin-right":"15px","cursor":"pointer"},on:{"click":function($event){_vm.showModal = false}}},[_vm._v("\n                    Cancel\n                  ")]),_c('input',{staticClass:"btn-submit",staticStyle:{"margin":"0"},attrs:{"type":"submit","value":"Submit"}})])])])])],2)])])]),_c('div',{staticStyle:{"display":"flex","height":"100%"}},[_c('datepicker',{attrs:{"highlighted":_vm.highlighted,"value":_vm.datePick,"inline":true},on:{"input":_vm.selectDate},model:{value:(_vm.datePick),callback:function ($$v) {_vm.datePick=$$v},expression:"datePick"}}),_c('div',{attrs:{"id":"container-right"}},[_c('a',{staticClass:"btn-calendar",on:{"click":function($event){_vm.showModal = true}}},[_vm._v("Add an event for "+_vm._s(_vm.moment(_vm.datePick).format('MMM Do YYYY')))]),_c('div',{attrs:{"id":"container-events"}},_vm._l((_vm.calendar.getDayEvents(new Date(_vm.moment(_vm.datePick).format('MM[/]DD[/]YYYY')))),function(event){return _c('div',{key:event.id,staticClass:"single-event",staticStyle:{"color":"white"}},[_c('span',[_vm._v(_vm._s(event.name)+" "+_vm._s(event.place ? 'at ' + event.place : ''))]),_c('button',{staticStyle:{"float":"right","background":"transparent","color":"white","border":"1px solid white"},on:{"click":function($event){_vm.deleteEvent(event)}}},[_vm._v("X\n          ")]),_c('hr'),_c('span',[_vm._v(_vm._s(event.description))])])}))])],1),_c('keyboard',{attrs:{"text":_vm.cityName,"input":'inputCity'},on:{"update:text":function($event){_vm.cityName=$event}}}),_c('keyboard',{attrs:{"text":_vm.form.name,"input":'name'},on:{"update:text":function($event){_vm.$set(_vm.form, "name", $event)}}}),_c('keyboard',{attrs:{"text":_vm.form.place,"input":'place'},on:{"update:text":function($event){_vm.$set(_vm.form, "place", $event)}}}),_c('keyboard',{attrs:{"text":_vm.form.desc,"input":'desc'},on:{"update:text":function($event){_vm.$set(_vm.form, "desc", $event)}}})],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./Calendar.vue?vue&type=template&id=d54287be&scoped=true&
...
// CONCATENATED MODULE: /Users/albanbin/Documents/dev/ureflect/boilerplate/node_modules/vuejs-datepicker/dist/vuejs-datepicker.esm.js
/*!
...
// EXTERNAL MODULE: /Users/albanbin/Documents/dev/ureflect/boilerplate/node_modules/moment/moment.js
var moment = __webpack_require__("c206");
var moment_default = /*#__PURE__*/__webpack_require__.n(moment);

// CONCATENATED MODULE: /Users/albanbin/Documents/dev/ureflect/boilerplate/node_modules/thread-loader/dist/cjs.js!/Users/albanbin/Documents/dev/ureflect/boilerplate/node_modules/babel-loader/lib??ref--12-1!/Users/albanbin/Documents/dev/ureflect/boilerplate/node_modules/cache-loader/dist/cjs.js??ref--0-0!/Users/albanbin/Documents/dev/ureflect/boilerplate/node_modules/vue-loader/lib??vue-loader-options!./Calendar.vue?vue&type=script&lang=js&
...
/* global CacheManager */
// import {Calendar, Event, CacheManager} from 'reflectos-sdk'


/* harmony default export */ var lib_vue_loader_options_Calendarvue_type_script_lang_js_ = ({
  name: 'calendar',
  components: {
  ...
  data: function data() {
    return {
      ...
      stateEmail: false,
      statePassword: false,
      cacheManager: new CacheManager('calendar')
    };
  },
  mounted: function mounted() {
    this.cacheManager.store('test', 'test');
    this.highlighted['dates'].push(new Date(this.datePick));
    var events = this.cacheManager.get('events');

    if (events) {
      for (var i = 0; i < events.length; i++) {
        console.log(events[i]);
        this.highlighted['dates'].push(new Date(events[i].date));
        var event = new Event(events[i].name, new Date(moment_default()(events[i].date).format('MM[/]DD[/]YYYY')), events[i].place, events[i].description);
  ...
  methods: {
    addEvent: function addEvent(evt) {
      evt.preventDefault();
      var event = new Event(this.form.name, new Date(moment_default()(this.datePick).format('MM[/]DD[/]YYYY')), this.form.place, this.form.desc);
      this.calendar.addEvent(event);
      var d = event.getDate();
      var stored = [];
      var caches = this.cacheManager.get('events');

      if (caches != null) {
        for (var i = 0; i < caches.length; i++) {
          stored.push(caches[i]);
        }
      }

      console.log(stored);
      stored.push(event);
      this.cacheManager.store('events', stored);
      console.log(this.cacheManager.get('events'));
      this.highlighted['dates'].push(new Date(this.datePick));
      this.form.name = '';
      this.form.place = '';
      this.form.desc = '';
    ...
    selectDate: function selectDate() {
      var d = new Date(moment_default()(this.datePick).format('MM[/]DD[/]YYYY'));
    ...
    deleteEvent: function deleteEvent(event) {
      ...
      if (caches != null) {
        for (var i = 0; i < caches.length; i++) {
          if (event.name === caches[i].name && event.description === caches[i].description) {
            caches.splice(i, 1);
          }
        }
      }

      this.cacheManager.store('events', caches);
      this.calendar.removeEvent(event);
    }
  }
});
// CONCATENATED MODULE: ./Calendar.vue?vue&type=script&lang=js&
 /* harmony default export */ var Calendarvue_type_script_lang_js_ = (lib_vue_loader_options_Calendarvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./Calendar.vue?vue&type=style&index=0&id=d54287be&scoped=true&lang=css&
var Calendarvue_type_style_index_0_id_d54287be_scoped_true_lang_css_ = __webpack_require__("f80b");

// EXTERNAL MODULE: ./Calendar.vue?vue&type=style&index=1&lang=css&
var Calendarvue_type_style_index_1_lang_css_ = __webpack_require__("a4b1");

// EXTERNAL MODULE: ./Calendar.vue?vue&type=style&index=2&id=d54287be&scoped=true&lang=css&
var Calendarvue_type_style_index_2_id_d54287be_scoped_true_lang_css_ = __webpack_require__("3a5f");

// CONCATENATED MODULE: /Users/albanbin/Documents/dev/ureflect/boilerplate/node_modules/vue-loader/lib/runtime/componentNormalizer.js
...
// CONCATENATED MODULE: ./Calendar.vue
...
var component = normalizeComponent(
  Calendarvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var Calendar_0 = (component.exports);
// CONCATENATED MODULE: /Users/albanbin/.config/yarn/global/node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (Calendar_0);
...
"use strict";
/* harmony import */ var _config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_1_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("74c0");
/* harmony import */ var _config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_1_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_1_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_1_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__("1067")(module)))
...
"use strict";
/* harmony import */ var _config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_0_id_d54287be_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("836d");
/* harmony import */ var _config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_0_id_d54287be_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_0_id_d54287be_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_config_yarn_global_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_config_yarn_global_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_0_id_d54287be_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
//# sourceMappingURL=ur-calendar.umd.js.map